...
class ViewTeamTodoScreen extends Component {
  constructor() {
    super();
    this.state = {
      isLoading: true,
  ...
  handleUpdateComment = item => {
    ...
    this.props.navigation.navigate("EditTeamCommentScreen", {
      commentID: item.key
    });
  };
    ...
    return (
      <View style={{ flex: 1, backgroundColor: colors.bgMain }}>
        ...
        <View style={styles.taskContainer}>
          ...
          <Text style={styles.taskUsername}>{this.state.task.Username}</Text>
